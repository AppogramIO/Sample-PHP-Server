<?php
 ...
 $linear_object = new stdClass();
 $linear_object->name="Cities Fahrenheit";
 $linear_object->startColor = $colors[0];
 $linear_object->endColor = $colors[2];
 $linear_object->circleColor = $colors[5];
 $linear_object->borderColor = $colors[6];
 $linear_object->points = $cities;

 //push object to array
 array_push($charts,$linear_object);
